...
\begin{verbatim}
Thursday, 27 October, 2022, 21:38
----------------------------------------
...
\NormalTok{   user  system elapsed }
  \FloatTok{0.079}   \FloatTok{0.000}   \FloatTok{0.080} 
...
\(0.08/0.002 = 40\) vezes mais rápido.
...
\SpecialCharTok{\textless{}}\NormalTok{bytecode}\SpecialCharTok{:} \DecValTok{0x560d0036a208}\SpecialCharTok{\textgreater{}}
...
\NormalTok{\}}
\SpecialCharTok{\textless{}}\NormalTok{bytecode}\SpecialCharTok{:} \DecValTok{0x560d00733f20}\SpecialCharTok{\textgreater{}}
\ErrorTok{\textless{}}\NormalTok{environment}\SpecialCharTok{:}\NormalTok{ namespace}\SpecialCharTok{:}\NormalTok{base}\SpecialCharTok{\textgreater{}}
\end{Highlighting}
\end{Shaded}

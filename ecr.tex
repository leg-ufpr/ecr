...
\NormalTok{   user  system elapsed }
  \FloatTok{0.061}   \FloatTok{0.000}   \FloatTok{0.061} 
...
regra da reciclagem, o cálculo é aproximadamente \(0.061/0.002 = 30.5\)
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.060}   \FloatTok{0.004}   \FloatTok{0.064} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.283}   \FloatTok{0.004}   \FloatTok{0.287} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.287/0.064 = 4.48 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x16b2968}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x5562480}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

...
\begin{verbatim}
Wednesday, 26 October, 2022, 17:38
----------------------------------------
...
\NormalTok{   user  system elapsed }
  \FloatTok{0.075}   \FloatTok{0.000}   \FloatTok{0.074} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.002}   \FloatTok{0.001}   \FloatTok{0.002} 
\end{Highlighting}
\end{Shaded}
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.072}   \FloatTok{0.004}   \FloatTok{0.076} 
...
\SpecialCharTok{\textless{}}\NormalTok{bytecode}\SpecialCharTok{:} \DecValTok{0x563a9d7eafa0}\SpecialCharTok{\textgreater{}}
...
\NormalTok{\}}
\SpecialCharTok{\textless{}}\NormalTok{bytecode}\SpecialCharTok{:} \DecValTok{0x563a9dbb4f20}\SpecialCharTok{\textgreater{}}
\ErrorTok{\textless{}}\NormalTok{environment}\SpecialCharTok{:}\NormalTok{ namespace}\SpecialCharTok{:}\NormalTok{base}\SpecialCharTok{\textgreater{}}
\end{Highlighting}
\end{Shaded}

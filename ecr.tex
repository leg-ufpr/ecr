...
\NormalTok{   user  system elapsed }
  \FloatTok{0.104}   \FloatTok{0.000}   \FloatTok{0.102} 
...
regra da reciclagem, o cálculo é aproximadamente 0.102/0.002 = 51 vezes
mais rápido. Claramente esse é só um exemplo de um cálculo muito
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.116}   \FloatTok{0.000}   \FloatTok{0.116} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.340}   \FloatTok{0.024}   \FloatTok{0.366} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.366/0.116 = 3.16 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x293bc90}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x2937398}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

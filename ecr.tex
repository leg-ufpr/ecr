...
\NormalTok{   user  system elapsed }
  \FloatTok{0.164}   \FloatTok{0.004}   \FloatTok{0.170} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.004}   \FloatTok{0.000}   \FloatTok{0.006} 
\end{Highlighting}
\end{Shaded}
...
regra da reciclagem, o cálculo é aproximadamente 0.17/0.006 = 28.33
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.132}   \FloatTok{0.004}   \FloatTok{0.136} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.508}   \FloatTok{0.048}   \FloatTok{0.556} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.556/0.136 = 4.09 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x7205780}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x7204da8}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{milsa}\SpecialCharTok{$}\NormalTok{Inst }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(milsa}\SpecialCharTok{$}\NormalTok{Inst,}
                     \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"1o Grau"}\NormalTok{, }\StringTok{"2o Grau"}\NormalTok{, }\StringTok{"Superior"}\NormalTok{),}
                     \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"1o Grau"}\NormalTok{, }\StringTok{"2o Grau"}\NormalTok{, }\StringTok{"Superior"}\NormalTok{),}
                                \AttributeTok{ordered =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{milsa}\SpecialCharTok{$}\NormalTok{Idade }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(milsa, Anos }\SpecialCharTok{+}\NormalTok{ Meses}\SpecialCharTok{/}\DecValTok{12}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{with}\NormalTok{(milsa, }\FunctionTok{mean}\NormalTok{(Filhos, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{))}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{1.65}
\DocumentationTok{\#\# Média aparada}
\FunctionTok{with}\NormalTok{(milsa, }\FunctionTok{mean}\NormalTok{(Filhos, }\AttributeTok{trim =} \FloatTok{0.1}\NormalTok{, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{))}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{1.5625}
\DocumentationTok{\#\# Quartis}
\FunctionTok{with}\NormalTok{(milsa, }\FunctionTok{quantile}\NormalTok{(Filhos, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{))}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Salario"}
...
\NormalTok{salario.cut }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(milsa, }\FunctionTok{cut}\NormalTok{(Salario, }\AttributeTok{breaks =}  \FunctionTok{quantile}\NormalTok{(milsa}\SpecialCharTok{$}\NormalTok{Salario),}
                               \AttributeTok{include.lowest =} \ConstantTok{TRUE}\NormalTok{))}
\DocumentationTok{\#\# Tabela de frequências absolutas}
\NormalTok{inst.sal.tb }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(milsa, }\FunctionTok{table}\NormalTok{(Inst, salario.cut))}
\NormalTok{inst.sal.tb}
\NormalTok{          salario.cut}
\NormalTok{Inst       [}\DecValTok{4}\NormalTok{,}\FloatTok{7.55}\NormalTok{] (}\FloatTok{7.55}\NormalTok{,}\FloatTok{10.2}\NormalTok{] (}\FloatTok{10.2}\NormalTok{,}\FloatTok{14.1}\NormalTok{] (}\FloatTok{14.1}\NormalTok{,}\FloatTok{23.3}\NormalTok{]}

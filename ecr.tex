...
\NormalTok{   user  system elapsed }
  \FloatTok{0.112}   \FloatTok{0.000}   \FloatTok{0.109} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.004}   \FloatTok{0.000}   \FloatTok{0.002} 
\end{Highlighting}
\end{Shaded}
...
regra da reciclagem, o cálculo é aproximadamente \(0.109/0.002 = 54.5\)
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.108}   \FloatTok{0.000}   \FloatTok{0.108} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.348}   \FloatTok{0.052}   \FloatTok{0.400} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.4/0.108 = 3.7 vezes. Isso acontece porque, da
segunda forma, o vetor \texttt{out} precisa ter seu tamanho aumentado
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x32f3640}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x3d770f8}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

...
\NormalTok{   user  system elapsed }
  \FloatTok{0.104}   \FloatTok{0.004}   \FloatTok{0.110} 
...
regra da reciclagem, o cálculo é aproximadamente 0.11/0.002 = 55 vezes
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.104}   \FloatTok{0.004}   \FloatTok{0.108} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.328}   \FloatTok{0.012}   \FloatTok{0.343} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.343/0.108 = 3.18 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x569b8b8}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x569af18}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

...
\NormalTok{   user  system elapsed }
  \FloatTok{0.100}   \FloatTok{0.000}   \FloatTok{0.101} 
...
regra da reciclagem, o cálculo é aproximadamente \(0.101/0.003 = 33.67\)
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.100}   \FloatTok{0.000}   \FloatTok{0.102} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.324}   \FloatTok{0.008}   \FloatTok{0.330} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.33/0.102 = 3.24 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x28d6008}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x28d69e0}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

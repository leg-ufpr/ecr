...
\NormalTok{   user  system elapsed }
  \FloatTok{0.096}   \FloatTok{0.004}   \FloatTok{0.101} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.000}   \FloatTok{0.000}   \FloatTok{0.002} 
\end{Highlighting}
\end{Shaded}
...
regra da reciclagem, o cálculo é aproximadamente 0.101/0.002 = 50.5
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.104}   \FloatTok{0.000}   \FloatTok{0.104} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.324}   \FloatTok{0.036}   \FloatTok{0.363} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.363/0.104 = 3.49 vezes. Isso acontece porque,
...
\NormalTok{label}\OperatorTok{:}\StringTok{ }\NormalTok{unnamed}\OperatorTok{-}\NormalTok{chunk}\OperatorTok{-}\DecValTok{414}
...
\begin{center}\includegraphics{figures/unnamed-chunk-415-1} \end{center}
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x1cbbdc8}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x1cbc768}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

...
\NormalTok{   user  system elapsed }
   \FloatTok{0.06}    \FloatTok{0.00}    \FloatTok{0.06} 
...
regra da reciclagem, o cálculo é aproximadamente \(0.06/0.002 = 30\)
...
\NormalTok{st1}
\NormalTok{   user  system elapsed }
  \FloatTok{0.063}   \FloatTok{0.000}   \FloatTok{0.063} 
...
\NormalTok{st2}
\NormalTok{   user  system elapsed }
  \FloatTok{0.258}   \FloatTok{0.028}   \FloatTok{0.286} 
\end{Highlighting}
\end{Shaded}

Essa simples diferença gera um aumento de tempo de execução da segunda
forma em aproximadamente 0.286/0.063 = 4.54 vezes. Isso acontece porque,
...
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x20a2968}\OperatorTok{>}
...
\NormalTok{\}}
\OperatorTok{<}\NormalTok{bytecode}\OperatorTok{:}\StringTok{ }\DecValTok{0x5f4e640}\OperatorTok{>}
\ErrorTok{<}\NormalTok{environment}\OperatorTok{:}\StringTok{ }\NormalTok{namespace}\OperatorTok{:}\NormalTok{base}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}

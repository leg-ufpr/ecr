...
```{r external-code-cap4, cache=FALSE, include=FALSE}
...
a tecla <kbd>Enter</kbd>  e o texto será armazenado no objeto texto.
...
1. Baixe os arquivos a seguir e coloque os arquivos em um local apropriado
...
Esse comando irá criar o arquivo (binário) `dados.rda`. Note que a extensão
